...
let AuthController = class AuthController {
    ...
    login(loginAuthDto) {
        console.log(login_auth_dto_1.LoginAuthDto);
...
__decorate([
    ...
    (0, dist_1.ApiOperation)({
        summary: '登录接口'
    }),
    (0, dist_1.ApiOkResponse)({ description: '登录成功返回', type: auth_vo_1.LoginResponse }),
